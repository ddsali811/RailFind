...
<https://railfind-mvp.onrender.com>

健康檢查：

<https://railfind-mvp.onrender.com/health>
...
- Render免費版閒置一段時間後會休眠，第一次開啟可能需要等待約50秒或更久才會喚醒。
...
```text
這是 Render 免費版，若網站一開始打開比較慢，請等約50秒讓服務喚醒，
再重新整理一次。這是免費版正常限制，不是網站壞掉。
```
